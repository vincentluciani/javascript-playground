...
var putBorderBackgroundOrderBasedOnCompletion = function(currentDiv,newCompletionPercentage){
    ...
    if (newCompletionPercentage>=100){
        ...
        currentDiv.style.border="1px solid #dedddd";
        ...
        /*currentDiv.style.boxShadow = "0px 5px 5px rgba(0, 0, 0, .12)";*/
        currentDiv.style.boxShadow = "0px 1px 8px 1px rgba(0, 0, 0, 0.12)";
